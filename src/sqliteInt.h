...
void sqlite4RollbackAll(sqlite4*);
...
void sqlite4CommitTransaction(Parse*);
void sqlite4RollbackTransaction(Parse*);
...
int sqlite4GenerateIndexKey(Parse*, Index*, int, int, int);
