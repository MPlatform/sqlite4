...
More precisely, the following invocation must be supported:
  ...
  make -f $::MAKEFILE fulltest OPTS="-DSQLITE4_SECURE_DELETE=1 -DSQLITE4_DEBUG=1"
...
array set ::Configs {
  ...
  "Ftrapv" {
    -O2 -ftrapv
    -DSQLITE4_MAX_ATTACHED=55
    -DSQLITE4_TCL_DEFAULT_FULLMUTEX=1
  }
  "Unlock-Notify" {
    -O2
    -DSQLITE4_ENABLE_UNLOCK_NOTIFY
    -DSQLITE4_THREADSAFE
    -DSQLITE4_TCL_DEFAULT_FULLMUTEX=1
  }
  "Secure-Delete" {
    -O2
    -DSQLITE4_SECURE_DELETE=1
    -DSQLITE4_SOUNDEX=1
  }
  "Update-Delete-Limit" {
    -O2
    -DSQLITE4_DEFAULT_FILE_FORMAT=4
    -DSQLITE4_ENABLE_UPDATE_DELETE_LIMIT=1
  }
  "Debug-One" {
    -O2
    -DSQLITE4_DEBUG=1
    -DSQLITE4_MEMDEBUG=1
    -DSQLITE4_MUTEX_NOOP=1
    -DSQLITE4_TCL_DEFAULT_FULLMUTEX=1
    -DSQLITE4_ENABLE_FTS3=1
    -DSQLITE4_ENABLE_RTREE=1
    -DSQLITE4_ENABLE_MEMSYS5=1
    -DSQLITE4_ENABLE_MEMSYS3=1
    -DSQLITE4_ENABLE_COLUMN_METADATA=1
  }
  "Device-One" {
    -O2
    -DSQLITE4_DEBUG=1
    -DSQLITE4_DEFAULT_AUTOVACUUM=1
    -DSQLITE4_DEFAULT_CACHE_SIZE=64
    -DSQLITE4_DEFAULT_PAGE_SIZE=1024
    -DSQLITE4_DEFAULT_TEMP_CACHE_SIZE=32
    -DSQLITE4_DISABLE_LFS=1
    -DSQLITE4_ENABLE_ATOMIC_WRITE=1
    -DSQLITE4_ENABLE_IOTRACE=1
    -DSQLITE4_ENABLE_MEMORY_MANAGEMENT=1
    -DSQLITE4_MAX_PAGE_SIZE=4096
    -DSQLITE4_OMIT_LOAD_EXTENSION=1
    -DSQLITE4_OMIT_PROGRESS_CALLBACK=1
    -DSQLITE4_OMIT_VIRTUALTABLE=1
    -DSQLITE4_TEMP_STORE=3
  }
  "Device-Two" {
    -DSQLITE4_4_BYTE_ALIGNED_MALLOC=1
    -DSQLITE4_DEFAULT_AUTOVACUUM=1
    -DSQLITE4_DEFAULT_CACHE_SIZE=1000
    -DSQLITE4_DEFAULT_LOCKING_MODE=0
    -DSQLITE4_DEFAULT_PAGE_SIZE=1024
    -DSQLITE4_DEFAULT_TEMP_CACHE_SIZE=1000
    -DSQLITE4_DISABLE_LFS=1
    -DSQLITE4_ENABLE_FTS3=1
    -DSQLITE4_ENABLE_MEMORY_MANAGEMENT=1
    -DSQLITE4_ENABLE_RTREE=1
    -DSQLITE4_MAX_COMPOUND_SELECT=50
    -DSQLITE4_MAX_PAGE_SIZE=32768
    -DSQLITE4_OMIT_TRACE=1
    -DSQLITE4_TEMP_STORE=3
    -DSQLITE4_THREADSAFE=2
  }
  "Locking-Style" {
    -O2
    -DSQLITE4_ENABLE_LOCKING_STYLE=1
  }
  "OS-X" {
    -DSQLITE4_OMIT_LOAD_EXTENSION=1
    -DSQLITE4_DEFAULT_MEMSTATUS=0
    -DSQLITE4_THREADSAFE=2
    -DSQLITE4_OS_UNIX=1
    -DSQLITE4_ENABLE_LOCKING_STYLE=1
    -DUSE_PREAD=1
    -DSQLITE4_ENABLE_RTREE=1
    -DSQLITE4_ENABLE_FTS3=1
    -DSQLITE4_ENABLE_FTS3_PARENTHESIS=1
    -DSQLITE4_DEFAULT_CACHE_SIZE=1000
    -DSQLITE4_MAX_LENGTH=2147483645
    -DSQLITE4_MAX_VARIABLE_NUMBER=500000
    -DSQLITE4_DEBUG=1 
    -DSQLITE4_PREFER_PROXY_LOCKING=1
  }
  "Extra-Robustness" {
    -DSQLITE4_ENABLE_OVERSIZE_CELL_CHECK=1
    -DSQLITE4_MAX_ATTACHED=62
  }
}
...
proc run_test_suite {name testtarget config} {
  ...
  set opts   [join $opts " "]
  append opts " -DSQLITE4_NO_SYNC=1 -DHAVE_USLEEP"
  ...
  if {$::tcl_platform(platform)=="windows"} {
    append opts " -DSQLITE4_OS_WIN=1"
  } elseif {$::tcl_platform(platform)=="os2"} {
    append opts " -DSQLITE4_OS_OS2=1"
  } else {
    append opts " -DSQLITE4_OS_UNIX=1"
  }
...
proc main {argv} {
  ...
  foreach {zConfig target} $::CONFIGLIST {
    ...
    # If the configuration included the SQLITE4_DEBUG option, then remove
    # it and run veryquick.test. If it did not include the SQLITE4_DEBUG option
    # add it and run veryquick.test.
    set debug_idx [lsearch -glob $config_options -DSQLITE4_DEBUG*]
    if {$debug_idx < 0} {
      run_test_suite "${zConfig}_debug" test [
        concat $config_options -DSQLITE4_DEBUG=1
      ]
    } else {
