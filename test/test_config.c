...
** macro. i.e. so that STRINGVALUE(SQLITE4_NOMEM) -> "7".
*/
...
static void set_options(Tcl_Interp *interp){
...
#ifdef SQLITE4_DIRECT_OVERFLOW_READ
...
#endif /* SQLITE4_OMIT_AUTOVACUUM */
#if !defined(SQLITE4_DEFAULT_AUTOVACUUM)
  ...
  Tcl_SetVar2(interp, "sqlite_options", "default_autovacuum", 
      STRINGVALUE(SQLITE4_DEFAULT_AUTOVACUUM), TCL_GLOBAL_ONLY);
#endif
...
#ifdef SQLITE4_ENABLE_MEMORY_MANAGEMENT
...
#if defined(SQLITE4_OMIT_PRAGMA) || defined(SQLITE4_OMIT_FLAG_PRAGMAS)
...
#if !defined(SQLITE4_ENABLE_LOCKING_STYLE)
#  if defined(__APPLE__)
#    define SQLITE4_ENABLE_LOCKING_STYLE 1
#  else
#    define SQLITE4_ENABLE_LOCKING_STYLE 0
#  endif
#endif
#if SQLITE4_ENABLE_LOCKING_STYLE && defined(__APPLE__)
...
#endif
#if defined(SQLITE4_PREFER_PROXY_LOCKING) && defined(__APPLE__)
  ...
  Tcl_SetVar2(interp, "sqlite_options", "threadsafe", 
      STRINGVALUE(SQLITE4_THREADSAFE), TCL_GLOBAL_ONLY);
...
#if defined(SQLITE4_OMIT_VACUUM) || defined(SQLITE4_OMIT_ATTACH)
...
#if defined(SQLITE4_ENABLE_UNLOCK_NOTIFY)
...
#ifdef SQLITE4_MULTIPLEX_EXT_OVWR
...
#define LINKVAR(x) { \
    static const int cv_ ## x = SQLITE4_ ## x; \
    Tcl_LinkVar(interp, "SQLITE4_" #x, (char *)&(cv_ ## x), \
