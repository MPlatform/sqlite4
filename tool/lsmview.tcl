...
proc draw_segment {C segment tags} {
  ...
  if {$bSep} {
    ...
    for {set i 3} {$i > 0} {incr i -1} {
      ...
      $C itemconfigure $id -outline black -fill "" -tags $tags

      incr y $h2
    }

    #incr y $::G(svertical_padding)
  }

  $C create rectangle 0 $y $w [expr $y+$h] -outline black -tags $tags
