...
struct sqlite4_tokenizer_module {
  ...
  */
  int (*xOpen)(sqlite4_tokenizer *pTokenizer,
...
*/
void sqlite4Fts1SimpleTokenizerModule(sqlite4_tokenizer_module const**ppModule);
void sqlite4Fts1PorterTokenizerModule(sqlite4_tokenizer_module const**ppModule);
